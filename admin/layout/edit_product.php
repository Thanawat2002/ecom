                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form theme-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter Amount Product">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-0"><a class="btn btn-success mr-3" href="#">Edit</a><a class="btn btn-danger" href="index.php?p=list_products">Cancel</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
