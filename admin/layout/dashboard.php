...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
      ...
      <!-- <div class="col-xl-4 xl-50 box-col-12">
        <div class="card">
          <div class="card-hader card-no-border">
            <h5>Location</h5>
            <div class="card-header-right">
              <ul class="list-unstyled card-option">
                <li><i class="fa fa-spin fa-cog"></i></li>
                          ...
                          <div class="col-xl-4 col-md-6">
                            <div class="d-flex">
                              <div class="left-content">
                                ...
                                <h4 class="f-w-600">Best Selling Product</h4><span class="badge badge-white badge-pill">78% offer</span><span class="badge badge-dotted badge-pill ml-2">Coupon Code : 12345</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-xl-4 col-md-6">
                            <div class="d-flex">
                              <div class="right-content">
                                ...
                                <h4 class="f-w-600">Women Straight Kurta</h4><span class="badge badge-white badge-pill">$100.00</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="selling-slide row">
                          ...
                          <div class="col-xl-4 col-md-6">
                            <div class="d-flex">
                              <div class="right-content">
                                <p>Money back Guarrantee</p>
                                <h4 class="f-w-600">Nike Air Shoes</h4><span class="badge badge-white badge-pill">$120.55</span>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-xl-4 col-md-6">
                            <div class="d-flex">
                              <div class="left-content">
                                ...
                                <h4 class="f-w-600">Best Selling Product</h4><span class="badge badge-white badge-pill">50% offer</span><span class="badge badge-dotted badge-pill ml-2">Coupon Code : 21546</span>
                              </div>
                            </div>
                          </div>
                          <div class="col-xl-4 col-md-12">
